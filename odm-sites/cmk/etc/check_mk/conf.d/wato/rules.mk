...
{'id': '59d84cde-ee3a-4f8d-8bec-fce35a2b0d15', 'value': True, 'condition': {}, 'options': {'description': 'All management boards use SNMP v2 (incl. bulk walks) by default'}},
] + management_bulkwalk_hosts
...
periodic_discovery = [
{'id': '95a56ffc-f17e-44e7-a162-be656f19bedf', 'value': {'severity_unmonitored': 1, 'severity_vanished': 0, 'check_interval': 120.0}, 'condition': {}, 'options': {'description': 'Perform every two hours a service discovery'}},
] + periodic_discovery
